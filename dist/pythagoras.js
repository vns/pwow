...
{
	if (region.ao.U === region.ay.U)
	{
		return 'on line ' + region.ao.U;
	}
	return 'on lines ' + region.ao.U + ' through ' + region.ay.U;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a4: 'hidden', P: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a4: 'mozHidden', P: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a4: 'msHidden', P: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a4: 'webkitHidden', P: 'webkitvisibilitychange' }
		: { a4: 'hidden', P: 'visibilitychange' };
}
...
var author$project$Color$Palette$rgb = F3(
	function (r, g, b) {
		return {ae: 1, af: b, ai: g, an: r};
	});
var author$project$Color$Palette$red = A3(author$project$Color$Palette$rgb, 229, 89, 52);
var author$project$Color$Palette$white = A3(author$project$Color$Palette$rgb, 255, 255, 255);
...
var author$project$Main$baseTri = _List_fromArray(
	[
		_Utils_Tuple2(0, 0),
		_Utils_Tuple2(500, 0),
		_Utils_Tuple2(0, 200)
	]);
var author$project$Main$tria1 = author$project$Main$baseTri;
var author$project$Main$CW90 = 0;
var elm$core$Basics$negate = function (n) {
	return -n;
};
var author$project$Main$rotate = F2(
	function (rot, triangle) {
		var ptRot = function (_n0) {
			var x = _n0.a;
			var y = _n0.b;
			switch (rot) {
				case 0:
		...
		return A2(elm$core$List$map, ptRot, triangle);
	});
var author$project$Main$tria2 = A2(author$project$Main$rotate, 0, author$project$Main$baseTri);
var author$project$Main$CW180 = 1;
var author$project$Main$tria3 = A2(author$project$Main$rotate, 1, author$project$Main$baseTri);
var author$project$Main$CW270 = 2;
var author$project$Main$tria4 = A2(author$project$Main$rotate, 2, author$project$Main$baseTri);
...
var mdgriffith$elm_style_animation$Animation$initMotion = F2(
	function (position, unit) {
		return {
			H: mdgriffith$elm_style_animation$Animation$Model$Spring(
				{aw: 26, aS: 170}),
...
var mdgriffith$elm_style_animation$Animation$alignStartingPoint = function (pnts) {
	var sums = A2(
		elm$core$List$map,
		function (_n2) {
			var x_ = _n2.a;
...
var mdgriffith$elm_style_animation$Animation$points = function (pnts) {
	return mdgriffith$elm_style_animation$Animation$Model$Points(
		A2(
			...
			mdgriffith$elm_style_animation$Animation$alignStartingPoint(pnts)));
};
...
var mdgriffith$elm_style_animation$Animation$initialState = function (current) {
	return {
		...
		aT: current,
		aW: {
			av: elm$time$Time$millisToPosix(0),
			a0: elm$time$Time$millisToPosix(0)
		}
	};
};
...
var mdgriffith$elm_style_animation$Animation$defaultInterpolationByProperty = function (prop) {
	var linear = function (duration) {
		return mdgriffith$elm_style_animation$Animation$Model$Easing(
			{ag: duration, ah: elm$core$Basics$identity, aM: 1, ao: 0});
	};
	...
	switch (prop.$) {
		...
		case 5:
			...
			return (name === 'rotate3d') ? mdgriffith$elm_style_animation$Animation$speed(
				{aH: elm$core$Basics$pi}) : defaultSpring;
		case 6:
			return defaultSpring;
		case 7:
			return mdgriffith$elm_style_animation$Animation$speed(
				{aH: elm$core$Basics$pi});
		case 8:
			return defaultSpring;
		default:
			return defaultSpring;
		...
		switch (cmd.$) {
			...
			case 7:
				...
				return mdgriffith$elm_style_animation$Animation$Model$VerticalTo(
					fn(motion));
			case 8:
				var control1 = cmd.a.R;
				var control2 = cmd.a.S;
				var point = cmd.a.p;
	...
	function (fn, prop) {
		switch (prop.$) {
			...
			case 2:
				...
				var size = shadow.q;
				var red = shadow.an;
				var offsetY = shadow.n;
				var offsetX = shadow.m;
				var green = shadow.ai;
				var blur = shadow.l;
				var blue = shadow.af;
				var alpha = shadow.ae;
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{
			B: 0,
			f: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$red),
						mdgriffith$elm_style_animation$Animation$points(author$project$Main$tria1)
					])),
			g: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$white),
						mdgriffith$elm_style_animation$Animation$points(
						A2(
							author$project$Main$translate,
							_Utils_Tuple2(700, 0),
							author$project$Main$tria2))
					])),
			h: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$white),
						mdgriffith$elm_style_animation$Animation$points(
						A2(
							author$project$Main$translate,
							_Utils_Tuple2(700, 700),
							author$project$Main$tria3))
					])),
			i: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$white),
						mdgriffith$elm_style_animation$Animation$points(
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {al: oldTime, aQ: request, aU: subs};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aA: fragment, aB: host, aG: path, aJ: port_, aN: protocol, aO: query};
	});
...
var author$project$Main$step0 = function (model) {
	var newTria4Style = _List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			A2(
				author$project$Main$translate,
	...
	var newTria3Style = _List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			A2(
				author$project$Main$translate,
	...
	var newTria2Style = _List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			A2(
				author$project$Main$translate,
	...
	var newTria1Style = _List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(author$project$Main$tria1),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$red)
		]);
	return _Utils_update(
		model,
		{
			f: A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$to(newTria1Style)
					]),
				model.f),
			g: A2(
				mdgriffith$elm_style_animation$Animation$interrupt,
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$to(newTria2Style)
					]),
				model.g),
			h: A2(
				mdgriffith$elm_style_animation$Animation$interrupt,
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$to(newTria3Style)
					]),
				model.h),
			i: A2(
				mdgriffith$elm_style_animation$Animation$interrupt,
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$to(newTria4Style)
					]),
				model.i)
		});
};
var author$project$Color$Palette$green = A3(author$project$Color$Palette$rgb, 155, 197, 61);
	...
	var newTria4Style = _List_fromArray(
		[
			...
			A2(
				...
				_Utils_Tuple2(0, 700),
				author$project$Main$tria4)),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$green)
		]);
	var newTria3Style = _List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
...
var author$project$Main$step2 = function (model) {
	...
	var newTria1Style = _List_fromArray(
		[
			...
			A2(
				author$project$Main$translate,
				_Utils_Tuple2(200, 500),
				author$project$Main$tria1)),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Color$Palette$red)
		]);
	return _Utils_update(
		model,
...
var author$project$Main$step3 = function (model) {
	var newTria4Style = _List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			A2(
...
var author$project$Main$updateWith = function (step) {
	switch (step) {
		case 0:
		...
		default:
			return author$project$Main$step3;
	}
};
...
var mdgriffith$elm_style_animation$Animation$Model$refreshTiming = F2(
	function (now, timing) {
		var dt = elm$time$Time$posixToMillis(now) - elm$time$Time$posixToMillis(timing.av);
		return {
			av: now,
			a0: ((dt > 34) || (!elm$time$Time$posixToMillis(timing.av))) ? elm$time$Time$millisToPosix(
...
var mdgriffith$elm_style_animation$Animation$Model$isCmdDone = function (cmd) {
	var motionDone = function (motion) {
		return (!motion.bo) && _Utils_eq(motion.bf, motion.bj);
	};
	switch (cmd.$) {
		case 0:
			var m1 = cmd.a;
		...
		case 16:
			var arc = cmd.a;
			return motionDone(arc.ac) && (motionDone(arc.ad) && (motionDone(arc.V) && (motionDone(arc.X) && motionDone(arc.T))));
		case 17:
			var arc = cmd.a;
			return motionDone(arc.ac) && (motionDone(arc.ad) && (motionDone(arc.V) && (motionDone(arc.X) && motionDone(arc.T))));
		default:
...
var mdgriffith$elm_style_animation$Animation$Model$isDone = function (property) {
	var motionDone = function (motion) {
		var runningInterpolation = A2(elm$core$Maybe$withDefault, motion.H, motion.a8);
		switch (runningInterpolation.$) {
			case 0:
				return (!motion.bo) && _Utils_eq(motion.bf, motion.bj);
			case 1:
				var eased = runningInterpolation.a;
				return (eased.aM === 1) || ((!eased.aM) && _Utils_eq(motion.bf, motion.bj));
			default:
				var speed = runningInterpolation.a;
				return _Utils_eq(motion.bf, motion.bj);
		}
	};
	switch (property.$) {
		case 0:
		...
		case 2:
			...
			return A2(
				...
				motionDone,
				_List_fromArray(
					[shadow.m, shadow.n, shadow.q, shadow.l, shadow.an, shadow.ai, shadow.af, shadow.ae]));
		case 3:
			var m1 = property.b;
			...
			function (motion, targetMotion) {
				...
				if (_n27.$ === 1) {
					...
					return _Utils_update(
						motion,
						{
							H: mdgriffith$elm_style_animation$Animation$Model$Easing(
								_Utils_update(
									ease,
									{ao: motion.bf})),
							bj: targetMotion.bf
			...
			case 8:
				...
				if (targetCmd.$ === 8) {
					...
					return mdgriffith$elm_style_animation$Animation$Model$Curve(
						{
							R: _Utils_Tuple2(
								A2(setMotionTarget, points.R.a, targets.R.a),
								A2(setMotionTarget, points.R.b, targets.R.b)),
							S: _Utils_Tuple2(
								A2(setMotionTarget, points.S.a, targets.S.a),
								A2(setMotionTarget, points.S.b, targets.S.b)),
							p: _Utils_Tuple2(
					...
					return mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
						function () {
							...
							return _Utils_update(
								arc,
								{
									T: A2(setMotionTarget, endAngle, target.T),
									V: A2(setMotionTarget, radius, target.V),
									X: A2(setMotionTarget, startAngle, target.X),
									ac: A2(setMotionTarget, x, target.ac),
									ad: A2(setMotionTarget, y, target.ad)
								});
						}());
				} else {
					return cmd;
		...
		var setMotionTarget = F2(
			function (motion, targetMotion) {
				var newMotion = overrideInterpolation ? _Utils_update(
					motion,
					{
						a8: elm$core$Maybe$Just(targetMotion.H)
					}) : motion;
				var _n13 = newMotion.a8;
				if (_n13.$ === 1) {
					var _n14 = newMotion.H;
					if (_n14.$ === 1) {
						var ease = _n14.a;
						return _Utils_update(
							newMotion,
				...
				if (newTarget.$ === 2) {
					...
					return A3(
						...
						inset,
						{
							...
							af: A2(setMotionTarget, shadow.af, targetShadow.af),
							l: A2(setMotionTarget, shadow.l, targetShadow.l),
							ai: A2(setMotionTarget, shadow.ai, targetShadow.ai),
							m: A2(setMotionTarget, shadow.m, targetShadow.m),
							n: A2(setMotionTarget, shadow.n, targetShadow.n),
							an: A2(setMotionTarget, shadow.an, targetShadow.an),
...
var mdgriffith$elm_style_animation$Animation$Model$stepInterpolation = F2(
	function (posix, motion) {
		var interpolationToUse = A2(elm$core$Maybe$withDefault, motion.H, motion.a8);
		var dtms = elm$time$Time$posixToMillis(posix);
		switch (interpolationToUse.$) {
			case 2:
				var perSecond = interpolationToUse.a.aH;
				var _n1 = function () {
					if (_Utils_cmp(motion.bf, motion.bj) < 0) {
						var _new = motion.bf + (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
							_Utils_cmp(_new, motion.bj) > -1);
					} else {
						var _new = motion.bf - (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
				...
				return finished ? _Utils_update(
					motion,
					{bf: motion.bj, bo: 0.0}) : _Utils_update(
					motion,
					{bf: newPos, bo: perSecond * 1000});
			case 0:
				var stiffness = interpolationToUse.a.aS;
				var damping = interpolationToUse.a.aw;
				var fspring = stiffness * (motion.bj - motion.bf);
				var fdamper = ((-1) * damping) * motion.bo;
				var dt = dtms / 1000;
				var a = fspring + fdamper;
				var newVelocity = motion.bo + (a * dt);
				var newPos = motion.bf + (newVelocity * dt);
				var dx = elm$core$Basics$abs(motion.bj - newPos);
				return ((_Utils_cmp(dx, mdgriffith$elm_style_animation$Animation$Model$tolerance) < 0) && (_Utils_cmp(
					...
					{bf: motion.bj, bo: 0.0}) : _Utils_update(
					motion,
					{bf: newPos, bo: newVelocity});
			default:
				var progress = interpolationToUse.a.aM;
				var duration = interpolationToUse.a.ag;
				var ease = interpolationToUse.a.ah;
				var start = interpolationToUse.a.ao;
				...
				var distance = motion.bj - start;
				var newPos = ((((eased * distance) + start) * 10000) | 0) / 10000;
				var newVelocity = (newProgress === 1) ? 0 : ((newPos - motion.bf) / dtms);
				var _n2 = motion.a8;
				if (_n2.$ === 1) {
					return _Utils_update(
						motion,
						{
							H: mdgriffith$elm_style_animation$Animation$Model$Easing(
								{ag: duration, ah: ease, aM: newProgress, ao: start}),
							bf: newPos,
							bo: newVelocity
						});
				} else {
				...
				return mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
					_Utils_update(
						arc,
						{
							...
							ac: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.ac),
			...
			switch (property.$) {
				...
				case 2:
					...
					return A3(
						...
						inset,
						{
							ae: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.ae),
							af: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.af),
							l: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.l),
							ai: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.ai),
							...
							an: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, shadow.an),
...
var mdgriffith$elm_style_animation$Animation$Model$updateAnimation = F2(
	function (_n0, _n1) {
		var now = _n0;
		var model = _n1;
		var timing = A2(mdgriffith$elm_style_animation$Animation$Model$refreshTiming, now, model.aW);
		var _n2 = A2(
			elm$core$List$partition,
			function (_n4) {
				var wait = _n4.a;
			...
			A2(
				...
				function (_n3) {
					...
					return _Utils_Tuple2(
						elm$time$Time$millisToPosix(
							elm$time$Time$posixToMillis(wait) - elm$time$Time$posixToMillis(timing.a0)),
						mySteps);
				},
				model.aj));
		...
		var _n5 = function () {
			...
			if (!_n6.$) {
				...
				return _Utils_Tuple2(model.ap, model.aT);
			}
		}();
		var steps = _n5.a;
		var style = _n5.b;
		var _n8 = A3(mdgriffith$elm_style_animation$Animation$Model$resolveSteps, style, steps, timing.a0);
		...
		if (msg.$ === 1) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						f: A2(mdgriffith$elm_style_animation$Animation$update, time, model.f),
						g: A2(mdgriffith$elm_style_animation$Animation$update, time, model.g),
						h: A2(mdgriffith$elm_style_animation$Animation$update, time, model.h),
						i: A2(mdgriffith$elm_style_animation$Animation$update, time, model.i)
					}),
				elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$Step3 = 3;
		...
		return A2(
			...
			A2(
				...
				function (_n11) {
					var x = _n11.a;
					var y = _n11.b;
					return elm$core$String$fromFloat(x.bf) + (',' + elm$core$String$fromFloat(y.bf));
				},
				coords));
	};
	switch (cmd.$) {
		case 0:
			var x = cmd.a;
			var y = cmd.b;
			return 'm ' + (elm$core$String$fromFloat(x.bf) + (',' + elm$core$String$fromFloat(y.bf)));
		case 1:
			var x = cmd.a;
			var y = cmd.b;
			return 'M ' + (elm$core$String$fromFloat(x.bf) + (',' + elm$core$String$fromFloat(y.bf)));
		case 2:
			var x = cmd.a;
			var y = cmd.b;
			return 'l ' + (elm$core$String$fromFloat(x.bf) + (',' + elm$core$String$fromFloat(y.bf)));
		case 3:
			var x = cmd.a;
			var y = cmd.b;
			return 'L ' + (elm$core$String$fromFloat(x.bf) + (',' + elm$core$String$fromFloat(y.bf)));
		case 4:
			var a = cmd.a;
			return 'h ' + elm$core$String$fromFloat(a.bf);
		case 5:
			var a = cmd.a;
			return 'H ' + elm$core$String$fromFloat(a.bf);
		case 6:
			var a = cmd.a;
			return 'v ' + elm$core$String$fromFloat(a.bf);
		case 7:
			var a = cmd.a;
			return 'V ' + elm$core$String$fromFloat(a.bf);
		case 8:
			...
			var c1x = _n3.a;
			var c1y = _n3.b;
			return 'c ' + (elm$core$String$fromFloat(c1x.bf) + (' ' + (elm$core$String$fromFloat(c1y.bf) + (', ' + (elm$core$String$fromFloat(c2x.bf) + (' ' + (elm$core$String$fromFloat(c2y.bf) + (', ' + (elm$core$String$fromFloat(p1x.bf) + (' ' + elm$core$String$fromFloat(p1y.bf)))))))))));
		case 9:
			var control1 = cmd.a.R;
			var control2 = cmd.a.S;
			var point = cmd.a.p;
		...
		case 10:
			...
			var c1x = _n8.a;
			var c1y = _n8.b;
			return 'q ' + (elm$core$String$fromFloat(c1x.bf) + (' ' + (elm$core$String$fromFloat(c1y.bf) + (', ' + (elm$core$String$fromFloat(p1x.bf) + (' ' + elm$core$String$fromFloat(p1y.bf)))))));
		case 11:
			var control = cmd.a.Q;
			var point = cmd.a.p;
			var _n9 = point;
		...
		case 16:
			var arc = cmd.a;
			var deltaAngle = arc.T.bf - arc.X.bf;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				var dy = arc.V.bf * elm$core$Basics$sin(
					elm$core$Basics$degrees(arc.X.bf));
				var dx = arc.V.bf * elm$core$Basics$cos(
					elm$core$Basics$degrees(arc.X.bf));
				return 'A ' + (elm$core$String$fromFloat(arc.V.bf) + (',' + (elm$core$String$fromFloat(arc.V.bf) + (',0,1,1,' + (elm$core$String$fromFloat(arc.ac.bf - dx) + (',' + (elm$core$String$fromFloat(arc.ad.bf - dy) + (' A ' + (elm$core$String$fromFloat(arc.V.bf) + (',' + (elm$core$String$fromFloat(arc.V.bf) + (',0,1,1,' + (elm$core$String$fromFloat(arc.ac.bf + dx) + (',' + elm$core$String$fromFloat(arc.ad.bf + dy)))))))))))))));
			} else {
				return 'A ' + (elm$core$String$fromFloat(arc.V.bf) + (',' + (elm$core$String$fromFloat(arc.V.bf) + (' 0 ' + (((deltaAngle >= 180) ? '1' : '0') + (' ' + ('1' + (' ' + (elm$core$String$fromFloat(
					arc.ac.bf + (arc.V.bf * elm$core$Basics$cos(
						elm$core$Basics$degrees(arc.T.bf)))) + (',' + elm$core$String$fromFloat(
					arc.ad.bf + (arc.V.bf * elm$core$Basics$sin(
						elm$core$Basics$degrees(arc.T.bf))))))))))))));
			}
		case 17:
			var arc = cmd.a;
			var deltaAngle = arc.T.bf - arc.X.bf;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				...
				var dx = arc.V.bf * elm$core$Basics$cos(
					elm$core$Basics$degrees(arc.X.bf));
				return 'A ' + (elm$core$String$fromFloat(arc.V.bf) + (',' + (elm$core$String$fromFloat(arc.V.bf) + (',0,1,0,' + (elm$core$String$fromFloat(arc.ac.bf - dx) + (',' + (elm$core$String$fromFloat(arc.ad.bf - dy) + (' A ' + (elm$core$String$fromFloat(arc.V.bf) + (',' + (elm$core$String$fromFloat(arc.V.bf) + (',0,1,1,' + (elm$core$String$fromFloat(arc.ac.bf + dx) + (',' + elm$core$String$fromFloat(arc.ad.bf + dy)))))))))))))));
			} else {
				return 'A ' + (elm$core$String$fromFloat(arc.V.bf) + (',' + (elm$core$String$fromFloat(arc.V.bf) + (' 0 ' + ((((arc.X.bf - arc.T.bf) >= 180) ? '1' : '0') + (' ' + ('0' + (' ' + (elm$core$String$fromFloat(
					arc.ac.bf + (arc.V.bf * elm$core$Basics$cos(arc.T.bf))) + (',' + elm$core$String$fromFloat(
					arc.ad.bf + (arc.V.bf * elm$core$Basics$sin(arc.T.bf)))))))))))));
			}
		default:
			return 'z';
	}
		...
		switch (prop.$) {
			...
			case 1:
				...
				return 'rgba(' + (elm$core$String$fromInt(
					elm$core$Basics$round(r.bf)) + (',' + (elm$core$String$fromInt(
					elm$core$Basics$round(g.bf)) + (',' + (elm$core$String$fromInt(
					elm$core$Basics$round(b.bf)) + (',' + (elm$core$String$fromFloat(a.bf) + ')')))))));
			case 2:
				var name = prop.a;
				var inset = prop.b;
				var shadow = prop.c;
				return (inset ? 'inset ' : '') + (elm$core$String$fromFloat(shadow.m.bf) + ('px' + (' ' + (elm$core$String$fromFloat(shadow.n.bf) + ('px' + (' ' + (elm$core$String$fromFloat(shadow.l.bf) + ('px' + (' ' + ((((name === 'text-shadow') || (name === 'drop-shadow')) ? '' : (elm$core$String$fromFloat(shadow.q.bf) + ('px' + ' '))) + ('rgba(' + (elm$core$String$fromInt(
					elm$core$Basics$round(shadow.an.bf)) + (', ' + (elm$core$String$fromInt(
					elm$core$Basics$round(shadow.ai.bf)) + (', ' + (elm$core$String$fromInt(
					elm$core$Basics$round(shadow.af.bf)) + (', ' + (elm$core$String$fromFloat(shadow.ae.bf) + ')'))))))))))))))))));
			case 3:
				var x = prop.b;
				return _Utils_ap(
					elm$core$String$fromFloat(x.bf),
					x.bl);
			case 4:
				var x = prop.b;
				var y = prop.c;
				return _Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							delim,
							_Utils_ap(
								elm$core$String$fromFloat(y.bf),
								y.bl))));
			case 5:
				var x = prop.b;
				var y = prop.c;
							...
							_Utils_ap(
								...
								_Utils_ap(
									...
									_Utils_ap(
										delim,
										_Utils_ap(
											elm$core$String$fromFloat(z.bf),
											z.bl)))))));
			case 6:
				var w = prop.b;
				var x = prop.c;
				...
				var z = prop.e;
				return _Utils_ap(
					elm$core$String$fromFloat(w.bf),
					_Utils_ap(
						w.bl,
						_Utils_ap(
							delim,
...
var mdgriffith$elm_style_animation$Animation$Render$render3dRotation = function (prop) {
	if (prop.$ === 5) {
		...
		var y = prop.c;
		var z = prop.d;
		return 'rotateX(' + (elm$core$String$fromFloat(x.bf) + (x.bl + (') rotateY(' + (elm$core$String$fromFloat(y.bf) + (y.bl + (') rotateZ(' + (elm$core$String$fromFloat(z.bf) + (z.bl + ')'))))))));
	} else {
		return '';
	}
};
var mdgriffith$elm_style_animation$Animation$Render$renderValues = function (_n0) {
	var model = _n0;
	var _n1 = A2(elm$core$List$partition, mdgriffith$elm_style_animation$Animation$Render$isAttr, model.aT);
	var attrProps = _n1.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$svg$Svg$Attributes$viewBox('0 0 700 700'),
							...
							[
								...
								_List_fromArray(
									[
										A2(
										elm$svg$Svg$polygon,
										mdgriffith$elm_style_animation$Animation$render(model.f),
										_List_Nil),
										A2(
										elm$svg$Svg$polygon,
										mdgriffith$elm_style_animation$Animation$render(model.g),
										_List_Nil),
										A2(
										elm$svg$Svg$polygon,
										mdgriffith$elm_style_animation$Animation$render(model.h),
										_List_Nil),
										A2(
										elm$svg$Svg$polygon,
										mdgriffith$elm_style_animation$Animation$render(model.i),
										_List_Nil)
									]))
							]))
					]))
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Main$stepView, 0, model.B),
						A2(author$project$Main$stepView, 1, model.B),
						A2(author$project$Main$stepView, 2, model.B),
						A2(author$project$Main$stepView, 3, model.B)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
var author$project$Main$main = elm$browser$Browser$element(
	{a7: author$project$Main$init, bi: author$project$Main$subscriptions, bm: author$project$Main$update, bp: author$project$Main$view});
