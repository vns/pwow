...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a1: 'hidden', L: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a1: 'mozHidden', L: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a1: 'msHidden', L: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a1: 'webkitHidden', L: 'webkitvisibilitychange' }
		: { a1: 'hidden', L: 'visibilitychange' };
}
...
var author$project$Main$Less = 1;
var author$project$Main$More = 2;
var author$project$Main$DoTransform = 0;
...
var elm$svg$Svg$set = elm$svg$Svg$trustedNode('set');
...
var author$project$Main$btn = function (model) {
	var _n0 = model.Q ? _Utils_Tuple2('#4A90E2', 'bwd') : _Utils_Tuple2('#ddd', 'fwd');
	var color = _n0.a;
	var attrId = _n0.b;
	return A2(
		elm$svg$Svg$rect,
		_List_fromArray(
			[
				...
				elm$svg$Svg$Attributes$id(attrId),
				elm$svg$Svg$Attributes$x('6'),
				elm$svg$Svg$Attributes$y('106'),
				elm$svg$Svg$Attributes$width('38'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$begin('click')
					]),
				_List_Nil)
			]));
};
var author$project$Main$square = F2(
	function (posX, posY) {
		var attrY = elm$core$String$fromInt(posY + 5);
		var attrX = elm$core$String$fromInt(posX + 5);
		return A2(
			elm$svg$Svg$rect,
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$x(attrX),
					elm$svg$Svg$Attributes$y(attrY),
...
var author$project$Main$rowOfSquares = function (n) {
	return A2(
		elm$core$List$map,
		function (i) {
			return A2(author$project$Main$square, (i - 1) * 50, (n - 1) * 50);
		},
...
var author$project$Main$transforms = function (model) {
	return _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$to('-50 50'),
					elm$svg$Svg$Attributes$dur('0.4s'),
					elm$svg$Svg$Attributes$repeatCount('1'),
					elm$svg$Svg$Attributes$fill('freeze'),
					elm$svg$Svg$Attributes$additive('sum'),
					elm$svg$Svg$Attributes$begin('rot1.end')
				]),
			_List_Nil),
			A2(
			elm$svg$Svg$animateTransform,
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$to('90'),
					elm$svg$Svg$Attributes$dur('1s'),
					elm$svg$Svg$Attributes$repeatCount('1'),
					elm$svg$Svg$Attributes$fill('freeze'),
					elm$svg$Svg$Attributes$additive('replace'),
					elm$svg$Svg$Attributes$begin('fwd.click'),
					elm$svg$Svg$Attributes$id('rot1')
				]),
			_List_Nil),
			A2(
			elm$svg$Svg$animateTransform,
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$attributeName('transform'),
					elm$svg$Svg$Attributes$type_('rotate'),
					elm$svg$Svg$Attributes$from('90'),
					elm$svg$Svg$Attributes$to('0'),
					elm$svg$Svg$Attributes$dur('1s'),
					elm$svg$Svg$Attributes$repeatCount('1'),
					elm$svg$Svg$Attributes$fill('freeze'),
					elm$svg$Svg$Attributes$additive('replace'),
					elm$svg$Svg$Attributes$begin('trans2.end')
				]),
			_List_Nil),
			A2(
			elm$svg$Svg$animateTransform,
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$fill('freeze'),
					elm$svg$Svg$Attributes$additive('sum'),
					elm$svg$Svg$Attributes$begin('bwd.click'),
					elm$svg$Svg$Attributes$id('trans2')
				]),
			_List_Nil)
		]);
};
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$svg$Svg$Attributes$fill('#ddd')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										elm$svg$Svg$Attributes$id('less'),
										elm$svg$Svg$Attributes$points('45,45 5,45 25,10'),
										elm$svg$Svg$Attributes$fill('#ddd'),
										elm$svg$Svg$Attributes$strokeWidth('0')
									]),
								_List_Nil),
								...
								_List_fromArray(
									[
										...
										elm$svg$Svg$Attributes$id('more'),
										elm$svg$Svg$Attributes$points('45,45 5,45 25,10'),
										elm$svg$Svg$Attributes$transform('translate(0, 255), scale(1, -1)'),
										elm$svg$Svg$Attributes$fill('#ddd'),
										elm$svg$Svg$Attributes$strokeWidth('0')
									]),
								_List_Nil),
								author$project$Main$btn(model)
							])),
						A2(
						elm$svg$Svg$g,
						_List_fromArray(
							[
								elm$svg$Svg$Attributes$width('500'),
								elm$svg$Svg$Attributes$height('500'),
								elm$svg$Svg$Attributes$transform('translate(500, 50) scale(-1, 1)')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$fill('#FDE74C')
									]),
								A2(
									elm$core$List$append,
									author$project$Main$transforms(model),
									elm$core$List$concat(
										A2(
											elm$core$List$map,
											author$project$Main$rowOfSquares,
											A2(elm$core$List$range, 1, model.i)))))
							])),
						A2(
						elm$svg$Svg$g,
						_List_fromArray(
							[
								elm$svg$Svg$Attributes$width('500'),
								elm$svg$Svg$Attributes$height('500'),
								elm$svg$Svg$Attributes$transform('translate(500, 0)')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$fill('#FA7921')
									]),
								elm$core$List$concat(
									A2(
										elm$core$List$map,
										author$project$Main$rowOfSquares,
										A2(elm$core$List$range, 1, model.i + 1))))
							]))
					]))
			]));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ax: fragment, ay: host, aD: path, aG: port_, aK: protocol, aL: query};
	});
...
var author$project$Main$main = elm$browser$Browser$element(
	{a4: author$project$Main$init, bf: author$project$Main$subscriptions, bj: author$project$Main$update, bm: author$project$Main$view});
