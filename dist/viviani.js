...
{
	if (region.c.af === region.d.af)
	{
		return 'on line ' + region.c.af;
	}
	return 'on lines ' + region.c.af + ' through ' + region.d.af;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a7: 'hidden', aa: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a7: 'mozHidden', aa: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a7: 'msHidden', aa: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a7: 'webkitHidden', aa: 'webkitvisibilitychange' }
		: { a7: 'hidden', aa: 'visibilitychange' };
}
...
var author$project$Main$Step0 = 0;
...
var author$project$Main$lineCenter = function (_n0) {
	var start = _n0.c;
	var end = _n0.d;
	var centerY = (_Utils_cmp(start.b, end.b) > 0) ? (end.b + ((start.b - end.b) / 2)) : ((_Utils_cmp(start.b, end.b) < 0) ? (start.b + ((end.b - start.b) / 2)) : start.b);
	var centerX = (_Utils_cmp(start.a, end.a) > 0) ? (end.a + ((start.a - end.a) / 2)) : ((_Utils_cmp(start.a, end.a) < 0) ? (start.a + ((end.a - start.a) / 2)) : start.a);
	return {a: centerX, b: centerY};
};
var author$project$Main$dot = F2(
	function (v1, v2) {
		return (v1.a * v2.a) + (v1.b * v2.b);
	});
var author$project$Main$norm = function (v) {
	return {
		a: v.a / elm$core$Basics$sqrt(
			A2(author$project$Main$dot, v, v)),
		b: v.b / elm$core$Basics$sqrt(
			A2(author$project$Main$dot, v, v))
	};
};
...
var author$project$Main$rotate90 = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	return {a: y, b: -x};
};
var author$project$Main$vectorFromLine = function (_n0) {
	var end = _n0.d;
	var start = _n0.c;
	return {a: end.a - start.a, b: end.b - start.b};
};
var elm$core$Basics$apR = F2(
	function (x, f) {
		return f(x);
	});
var author$project$Main$equilateralFromLine = function (line) {
	var side = A2(author$project$Main$dist, line.c, line.d);
	var normal = author$project$Main$rotate90(
		author$project$Main$norm(
			author$project$Main$vectorFromLine(line)));
	var height = elm$core$Basics$sqrt((side * side) - ((side * side) / 4));
	var center = author$project$Main$lineCenter(line);
	var apex = {a: center.a + (height * normal.a), b: center.b + (height * normal.b)};
	return {e: line.c, m: line.d, f: apex};
};
var author$project$Main$initEquilateral = author$project$Main$equilateralFromLine(
	{
		d: {a: 740, b: 740},
		c: {a: 10, b: 740}
	});
...
var mdgriffith$elm_style_animation$Animation$initMotion = F2(
	function (position, unit) {
		return {
			T: mdgriffith$elm_style_animation$Animation$Model$Spring(
				{aB: 26, aV: 170}),
...
var mdgriffith$elm_style_animation$Animation$rotate = function (_n0) {
	var valX = _n0;
	return A2(
...
var mdgriffith$elm_style_animation$Animation$defaultInterpolationByProperty = function (prop) {
	var linear = function (duration) {
		return mdgriffith$elm_style_animation$Animation$Model$Easing(
			{ao: duration, ap: elm$core$Basics$identity, aQ: 1, c: 0});
	};
	...
	switch (prop.$) {
		...
		case 5:
			...
			return (name === 'rotate3d') ? mdgriffith$elm_style_animation$Animation$speed(
				{aL: elm$core$Basics$pi}) : defaultSpring;
		case 6:
			return defaultSpring;
		case 7:
			return mdgriffith$elm_style_animation$Animation$speed(
				{aL: elm$core$Basics$pi});
		case 8:
			return defaultSpring;
		default:
			return defaultSpring;
		...
		switch (cmd.$) {
			...
			case 7:
				...
				return mdgriffith$elm_style_animation$Animation$Model$VerticalTo(
					fn(motion));
			case 8:
				var control1 = cmd.a.ac;
				var control2 = cmd.a.ad;
				var point = cmd.a.A;
	...
	function (fn, prop) {
		switch (prop.$) {
			...
			case 2:
				...
				var size = shadow.B;
				var red = shadow.s;
				var offsetY = shadow.y;
				var offsetX = shadow.x;
				var green = shadow.r;
				var blur = shadow.w;
				var blue = shadow.p;
				var alpha = shadow.o;
...
var author$project$Main$init = function (_n0) {
	var eq = author$project$Main$initEquilateral;
	var aPoint = {a: 300, b: 400};
	return _Utils_Tuple2(
		{
			v: aPoint,
			g: eq,
			t: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$rotate(
						mdgriffith$elm_style_animation$Animation$deg(0))
					])),
			u: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
						mdgriffith$elm_style_animation$Animation$rotate(
						mdgriffith$elm_style_animation$Animation$deg(0))
					])),
			D: mdgriffith$elm_style_animation$Animation$style(
				_List_fromArray(
					[
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {as: oldTime, aU: request, aX: subs};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aE: fragment, aF: host, aK: path, aN: port_, aR: protocol, aS: query};
	});
...
var author$project$Main$subscriptions = function (model) {
	return A2(
		...
		_List_fromArray(
			[model.D, model.t, model.u]));
};
var author$project$Main$projection = F2(
	function (line, point) {
		var x = author$project$Main$vectorFromLine(
			{d: point, c: line.c});
		var v = author$project$Main$vectorFromLine(line);
		var c = A2(author$project$Main$dot, x, v) / A2(author$project$Main$dot, v, v);
		return {a: line.c.a + (c * v.a), b: line.c.b + (c * v.b)};
	});
var elm$core$Basics$degrees = function (angleInDegrees) {
	return (angleInDegrees * elm$core$Basics$pi) / 180;
};
var elm$core$Basics$tan = _Basics_tan;
var author$project$Main$equilateral = F2(
	function (line, point) {
		var proj = A2(author$project$Main$projection, line, point);
		var u = author$project$Main$norm(
			author$project$Main$vectorFromLine(
				{d: proj, c: line.c}));
		var halfSide = elm$core$Basics$tan(
			elm$core$Basics$degrees(30)) * A2(author$project$Main$dist, proj, point);
		return {
			e: {a: proj.a - (u.a * halfSide), b: proj.b - (u.b * halfSide)},
			m: {a: proj.a + (u.a * halfSide), b: proj.b + (u.b * halfSide)},
			f: point
		};
	});
var author$project$Main$equilateralCenter = function (eq) {
	var proj = A2(
		author$project$Main$projection,
		{d: eq.m, c: eq.e},
		eq.f);
	var normal = author$project$Main$norm(
		author$project$Main$vectorFromLine(
			{d: eq.f, c: proj}));
	var half = A2(author$project$Main$dist, eq.e, eq.m) / 2;
	var offset = half * elm$core$Basics$tan(
		elm$core$Basics$degrees(30));
	return {a: proj.a + (offset * normal.a), b: proj.b + (offset * normal.b)};
};
...
var mdgriffith$elm_style_animation$Animation$transformOrigin = F3(
	function (_n0, _n1, _n2) {
		var valX = _n0.a;
		var len1 = _n0.b;
		var valY = _n1.a;
		...
		return A4(
			...
			_Utils_Tuple2(
				valZ,
				mdgriffith$elm_style_animation$Animation$lengthUnitName(len3)));
	});
var author$project$Main$step0 = function (model) {
	var eqBC = A2(
		author$project$Main$equilateral,
		{d: model.g.f, c: model.g.m},
		model.v);
	var eqAC = A2(
		author$project$Main$equilateral,
		{d: model.g.f, c: model.g.e},
		model.v);
	var eqUpper = A2(
		author$project$Main$equilateral,
		{d: eqBC.e, c: eqAC.e},
		model.g.f);
	var center2 = author$project$Main$equilateralCenter(eqUpper);
	var center1 = author$project$Main$equilateralCenter(eqAC);
	return _Utils_update(
		model,
		{
			t: A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3(
								mdgriffith$elm_style_animation$Animation$transformOrigin,
								mdgriffith$elm_style_animation$Animation$px(center1.a),
								mdgriffith$elm_style_animation$Animation$px(center1.b),
					...
					[
						...
						_List_fromArray(
							[
								A3(
								mdgriffith$elm_style_animation$Animation$transformOrigin,
								mdgriffith$elm_style_animation$Animation$px(center2.a),
								mdgriffith$elm_style_animation$Animation$px(center2.b),
								mdgriffith$elm_style_animation$Animation$px(0.0))
							])),
						mdgriffith$elm_style_animation$Animation$to(
						_List_fromArray(
...
var author$project$Main$Step1 = 1;
var author$project$Main$step1 = function (model) {
	var eqBC = A2(
		author$project$Main$equilateral,
		{d: model.g.f, c: model.g.m},
		model.v);
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_style_animation$Animation$rotate(
								mdgriffith$elm_style_animation$Animation$deg(120))
							]))
					]),
				model.t),
			u: A2(
...
var author$project$Main$Step2 = 2;
var author$project$Main$step2 = function (model) {
	var eqBC = A2(
		author$project$Main$equilateral,
		{d: model.g.f, c: model.g.m},
		model.v);
...
var author$project$Main$makeStepFn = function (step) {
	switch (step) {
		case 0:
			return author$project$Main$step0;
		case 1:
			return author$project$Main$step1;
		default:
			return author$project$Main$step2;
	}
};
var author$project$Main$leftOf = F2(
	function (point, line) {
		var v2 = author$project$Main$rotate90(
			author$project$Main$vectorFromLine(
				{d: line.d, c: line.c}));
		var v1 = author$project$Main$vectorFromLine(
			{d: point, c: line.c});
		return A2(author$project$Main$dot, v1, v2) > 0.0;
	});
var author$project$Main$pointInEquilateral = F2(
	function (pt, eq) {
		return A2(
			author$project$Main$leftOf,
			pt,
			{d: eq.m, c: eq.e}) && (A2(
			author$project$Main$leftOf,
			pt,
...
var mdgriffith$elm_style_animation$Animation$Model$refreshTiming = F2(
	function (now, timing) {
		var dt = elm$time$Time$posixToMillis(now) - elm$time$Time$posixToMillis(timing.aA);
		return {
			aA: now,
			a3: ((dt > 34) || (!elm$time$Time$posixToMillis(timing.aA))) ? elm$time$Time$millisToPosix(
...
var mdgriffith$elm_style_animation$Animation$Model$isCmdDone = function (cmd) {
	var motionDone = function (motion) {
		return (!motion.br) && _Utils_eq(motion.bi, motion.bm);
	};
	switch (cmd.$) {
		case 0:
			var m1 = cmd.a;
		...
		case 16:
			var arc = cmd.a;
			return motionDone(arc.a) && (motionDone(arc.b) && (motionDone(arc.ag) && (motionDone(arc.ai) && motionDone(arc.ae))));
		case 17:
			var arc = cmd.a;
			return motionDone(arc.a) && (motionDone(arc.b) && (motionDone(arc.ag) && (motionDone(arc.ai) && motionDone(arc.ae))));
		default:
...
var mdgriffith$elm_style_animation$Animation$Model$isDone = function (property) {
	var motionDone = function (motion) {
		var runningInterpolation = A2(elm$core$Maybe$withDefault, motion.T, motion.bb);
		switch (runningInterpolation.$) {
			case 0:
				return (!motion.br) && _Utils_eq(motion.bi, motion.bm);
			case 1:
				var eased = runningInterpolation.a;
				return (eased.aQ === 1) || ((!eased.aQ) && _Utils_eq(motion.bi, motion.bm));
			default:
				var speed = runningInterpolation.a;
				return _Utils_eq(motion.bi, motion.bm);
		}
	};
	switch (property.$) {
		case 0:
		...
		case 2:
			...
			return A2(
				...
				motionDone,
				_List_fromArray(
					[shadow.x, shadow.y, shadow.B, shadow.w, shadow.s, shadow.r, shadow.p, shadow.o]));
		case 3:
			var m1 = property.b;
			...
			function (motion, targetMotion) {
				...
				if (_n27.$ === 1) {
					...
					return _Utils_update(
						motion,
						{
							T: mdgriffith$elm_style_animation$Animation$Model$Easing(
								_Utils_update(
									ease,
									{c: motion.bi})),
							bm: targetMotion.bi
			...
			case 8:
				...
				if (targetCmd.$ === 8) {
					...
					return mdgriffith$elm_style_animation$Animation$Model$Curve(
						{
							ac: _Utils_Tuple2(
								A2(setMotionTarget, points.ac.a, targets.ac.a),
								A2(setMotionTarget, points.ac.b, targets.ac.b)),
							ad: _Utils_Tuple2(
								A2(setMotionTarget, points.ad.a, targets.ad.a),
								A2(setMotionTarget, points.ad.b, targets.ad.b)),
							A: _Utils_Tuple2(
					...
					return mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
						function () {
							...
							return _Utils_update(
								arc,
								{
									ae: A2(setMotionTarget, endAngle, target.ae),
									ag: A2(setMotionTarget, radius, target.ag),
									ai: A2(setMotionTarget, startAngle, target.ai),
									a: A2(setMotionTarget, x, target.a),
									b: A2(setMotionTarget, y, target.b)
								});
						}());
				} else {
					return cmd;
		...
		var setMotionTarget = F2(
			function (motion, targetMotion) {
				var newMotion = overrideInterpolation ? _Utils_update(
					motion,
					{
						bb: elm$core$Maybe$Just(targetMotion.T)
					}) : motion;
				var _n13 = newMotion.bb;
				if (_n13.$ === 1) {
					var _n14 = newMotion.T;
					if (_n14.$ === 1) {
						var ease = _n14.a;
						return _Utils_update(
							newMotion,
...
var mdgriffith$elm_style_animation$Animation$Model$stepInterpolation = F2(
	function (posix, motion) {
		var interpolationToUse = A2(elm$core$Maybe$withDefault, motion.T, motion.bb);
		var dtms = elm$time$Time$posixToMillis(posix);
		switch (interpolationToUse.$) {
			case 2:
				var perSecond = interpolationToUse.a.aL;
				var _n1 = function () {
					if (_Utils_cmp(motion.bi, motion.bm) < 0) {
						var _new = motion.bi + (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
							_Utils_cmp(_new, motion.bm) > -1);
					} else {
						var _new = motion.bi - (perSecond * (dtms / 1000));
						return _Utils_Tuple2(
							_new,
				...
				return finished ? _Utils_update(
					motion,
					{bi: motion.bm, br: 0.0}) : _Utils_update(
					motion,
					{bi: newPos, br: perSecond * 1000});
			case 0:
				var stiffness = interpolationToUse.a.aV;
				var damping = interpolationToUse.a.aB;
				var fspring = stiffness * (motion.bm - motion.bi);
				var fdamper = ((-1) * damping) * motion.br;
				var dt = dtms / 1000;
				var a = fspring + fdamper;
				var newVelocity = motion.br + (a * dt);
				var newPos = motion.bi + (newVelocity * dt);
				var dx = elm$core$Basics$abs(motion.bm - newPos);
				return ((_Utils_cmp(dx, mdgriffith$elm_style_animation$Animation$Model$tolerance) < 0) && (_Utils_cmp(
					...
					{bi: motion.bm, br: 0.0}) : _Utils_update(
					motion,
					{bi: newPos, br: newVelocity});
			default:
				var progress = interpolationToUse.a.aQ;
				var duration = interpolationToUse.a.ao;
				var ease = interpolationToUse.a.ap;
				var start = interpolationToUse.a.c;
				...
				var distance = motion.bm - start;
				var newPos = ((((eased * distance) + start) * 10000) | 0) / 10000;
				var newVelocity = (newProgress === 1) ? 0 : ((newPos - motion.bi) / dtms);
				var _n2 = motion.bb;
				if (_n2.$ === 1) {
					return _Utils_update(
						motion,
						{
							T: mdgriffith$elm_style_animation$Animation$Model$Easing(
								{ao: duration, ap: ease, aQ: newProgress, c: start}),
							bi: newPos,
							br: newVelocity
						});
				} else {
			...
			case 16:
				...
				return mdgriffith$elm_style_animation$Animation$Model$ClockwiseArc(
					_Utils_update(
						arc,
						{
							ae: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.ae),
							ag: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.ag),
							ai: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.ai),
							a: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.a),
							b: A2(mdgriffith$elm_style_animation$Animation$Model$stepInterpolation, dt, arc.b)
						}));
			case 17:
				var arc = cmd.a;
				return mdgriffith$elm_style_animation$Animation$Model$AntiClockwiseArc(
...
var mdgriffith$elm_style_animation$Animation$Model$updateAnimation = F2(
	function (_n0, _n1) {
		var now = _n0;
		var model = _n1;
		var timing = A2(mdgriffith$elm_style_animation$Animation$Model$refreshTiming, now, model.aZ);
		var _n2 = A2(
			elm$core$List$partition,
			function (_n4) {
				var wait = _n4.a;
			...
			A2(
				...
				function (_n3) {
					...
					return _Utils_Tuple2(
						elm$time$Time$millisToPosix(
							elm$time$Time$posixToMillis(wait) - elm$time$Time$posixToMillis(timing.a3)),
						mySteps);
				},
				model.aq));
		...
		var _n5 = function () {
			...
			if (!_n6.$) {
				...
				return _Utils_Tuple2(model.au, model.aW);
			}
		}();
		var steps = _n5.a;
		var style = _n5.b;
		var _n8 = A3(mdgriffith$elm_style_animation$Animation$Model$resolveSteps, style, steps, timing.a3);
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					aq: queuedInterruptions,
					an: elm$core$List$length(revisedSteps) || elm$core$List$length(queuedInterruptions),
					au: revisedSteps,
					aW: revisedStyle,
					aZ: timing
				}),
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var step = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Main$makeStepFn, step, model),
					elm$core$Platform$Cmd$none);
			case 1:
				var clickedPoint = msg.a;
				var newPoint = (A2(author$project$Main$pointInEquilateral, clickedPoint, model.g) && (!model.E)) ? clickedPoint : model.v;
				var inside = A2(author$project$Main$pointInEquilateral, clickedPoint, model.g);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{v: newPoint}),
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							t: A2(mdgriffith$elm_style_animation$Animation$update, animMsg, model.t),
							u: A2(mdgriffith$elm_style_animation$Animation$update, animMsg, model.u),
							D: A2(mdgriffith$elm_style_animation$Animation$update, animMsg, model.D)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$equilateralAsString = function (eq) {
	return elm$core$String$fromFloat(eq.e.a) + (',' + (elm$core$String$fromFloat(eq.e.b) + (' ' + (elm$core$String$fromFloat(eq.m.a) + (',' + (elm$core$String$fromFloat(eq.m.b) + (' ' + (elm$core$String$fromFloat(eq.f.a) + (',' + (elm$core$String$fromFloat(eq.f.b) + ' '))))))))));
};
...
var author$project$Main$onClickWithOffset = function (message) {
	return A2(
		elm$html$Html$Events$on,
		'click',
		A2(elm$json$Json$Decode$map, message, author$project$Main$pointDecoder));
};
		...
		return A2(
			...
			A2(
				...
				function (_n11) {
					var x = _n11.a;
					var y = _n11.b;
					return elm$core$String$fromFloat(x.bi) + (',' + elm$core$String$fromFloat(y.bi));
				},
				coords));
	};
	switch (cmd.$) {
		case 0:
			var x = cmd.a;
			var y = cmd.b;
			return 'm ' + (elm$core$String$fromFloat(x.bi) + (',' + elm$core$String$fromFloat(y.bi)));
		case 1:
			var x = cmd.a;
			var y = cmd.b;
			return 'M ' + (elm$core$String$fromFloat(x.bi) + (',' + elm$core$String$fromFloat(y.bi)));
		case 2:
			var x = cmd.a;
			var y = cmd.b;
			return 'l ' + (elm$core$String$fromFloat(x.bi) + (',' + elm$core$String$fromFloat(y.bi)));
		case 3:
			var x = cmd.a;
			var y = cmd.b;
			return 'L ' + (elm$core$String$fromFloat(x.bi) + (',' + elm$core$String$fromFloat(y.bi)));
		case 4:
			var a = cmd.a;
			return 'h ' + elm$core$String$fromFloat(a.bi);
		case 5:
			var a = cmd.a;
			return 'H ' + elm$core$String$fromFloat(a.bi);
		case 6:
			var a = cmd.a;
			return 'v ' + elm$core$String$fromFloat(a.bi);
		case 7:
			var a = cmd.a;
			return 'V ' + elm$core$String$fromFloat(a.bi);
		case 8:
			...
			var c1x = _n3.a;
			var c1y = _n3.b;
			return 'c ' + (elm$core$String$fromFloat(c1x.bi) + (' ' + (elm$core$String$fromFloat(c1y.bi) + (', ' + (elm$core$String$fromFloat(c2x.bi) + (' ' + (elm$core$String$fromFloat(c2y.bi) + (', ' + (elm$core$String$fromFloat(p1x.bi) + (' ' + elm$core$String$fromFloat(p1y.bi)))))))))));
		case 9:
			var control1 = cmd.a.ac;
			var control2 = cmd.a.ad;
			var point = cmd.a.A;
		...
		case 10:
			...
			var c1x = _n8.a;
			var c1y = _n8.b;
			return 'q ' + (elm$core$String$fromFloat(c1x.bi) + (' ' + (elm$core$String$fromFloat(c1y.bi) + (', ' + (elm$core$String$fromFloat(p1x.bi) + (' ' + elm$core$String$fromFloat(p1y.bi)))))));
		case 11:
			var control = cmd.a.ab;
			var point = cmd.a.A;
			var _n9 = point;
		...
		case 16:
			var arc = cmd.a;
			var deltaAngle = arc.ae.bi - arc.ai.bi;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				var dy = arc.ag.bi * elm$core$Basics$sin(
					elm$core$Basics$degrees(arc.ai.bi));
				var dx = arc.ag.bi * elm$core$Basics$cos(
					elm$core$Basics$degrees(arc.ai.bi));
				return 'A ' + (elm$core$String$fromFloat(arc.ag.bi) + (',' + (elm$core$String$fromFloat(arc.ag.bi) + (',0,1,1,' + (elm$core$String$fromFloat(arc.a.bi - dx) + (',' + (elm$core$String$fromFloat(arc.b.bi - dy) + (' A ' + (elm$core$String$fromFloat(arc.ag.bi) + (',' + (elm$core$String$fromFloat(arc.ag.bi) + (',0,1,1,' + (elm$core$String$fromFloat(arc.a.bi + dx) + (',' + elm$core$String$fromFloat(arc.b.bi + dy)))))))))))))));
			} else {
				return 'A ' + (elm$core$String$fromFloat(arc.ag.bi) + (',' + (elm$core$String$fromFloat(arc.ag.bi) + (' 0 ' + (((deltaAngle >= 180) ? '1' : '0') + (' ' + ('1' + (' ' + (elm$core$String$fromFloat(
					arc.a.bi + (arc.ag.bi * elm$core$Basics$cos(
						elm$core$Basics$degrees(arc.ae.bi)))) + (',' + elm$core$String$fromFloat(
					arc.b.bi + (arc.ag.bi * elm$core$Basics$sin(
						elm$core$Basics$degrees(arc.ae.bi))))))))))))));
			}
		case 17:
			var arc = cmd.a;
			var deltaAngle = arc.ae.bi - arc.ai.bi;
			if (_Utils_cmp(deltaAngle, 360 - 1.0e-6) > 0) {
				...
				var dx = arc.ag.bi * elm$core$Basics$cos(
					elm$core$Basics$degrees(arc.ai.bi));
				return 'A ' + (elm$core$String$fromFloat(arc.ag.bi) + (',' + (elm$core$String$fromFloat(arc.ag.bi) + (',0,1,0,' + (elm$core$String$fromFloat(arc.a.bi - dx) + (',' + (elm$core$String$fromFloat(arc.b.bi - dy) + (' A ' + (elm$core$String$fromFloat(arc.ag.bi) + (',' + (elm$core$String$fromFloat(arc.ag.bi) + (',0,1,1,' + (elm$core$String$fromFloat(arc.a.bi + dx) + (',' + elm$core$String$fromFloat(arc.b.bi + dy)))))))))))))));
			} else {
				return 'A ' + (elm$core$String$fromFloat(arc.ag.bi) + (',' + (elm$core$String$fromFloat(arc.ag.bi) + (' 0 ' + ((((arc.ai.bi - arc.ae.bi) >= 180) ? '1' : '0') + (' ' + ('0' + (' ' + (elm$core$String$fromFloat(
					arc.a.bi + (arc.ag.bi * elm$core$Basics$cos(arc.ae.bi))) + (',' + elm$core$String$fromFloat(
					arc.b.bi + (arc.ag.bi * elm$core$Basics$sin(arc.ae.bi)))))))))))));
			}
		default:
			return 'z';
	}
		...
		switch (prop.$) {
			...
			case 1:
				...
				return 'rgba(' + (elm$core$String$fromInt(
					elm$core$Basics$round(r.bi)) + (',' + (elm$core$String$fromInt(
					elm$core$Basics$round(g.bi)) + (',' + (elm$core$String$fromInt(
					elm$core$Basics$round(b.bi)) + (',' + (elm$core$String$fromFloat(a.bi) + ')')))))));
			case 2:
				var name = prop.a;
				var inset = prop.b;
				var shadow = prop.c;
				return (inset ? 'inset ' : '') + (elm$core$String$fromFloat(shadow.x.bi) + ('px' + (' ' + (elm$core$String$fromFloat(shadow.y.bi) + ('px' + (' ' + (elm$core$String$fromFloat(shadow.w.bi) + ('px' + (' ' + ((((name === 'text-shadow') || (name === 'drop-shadow')) ? '' : (elm$core$String$fromFloat(shadow.B.bi) + ('px' + ' '))) + ('rgba(' + (elm$core$String$fromInt(
					elm$core$Basics$round(shadow.s.bi)) + (', ' + (elm$core$String$fromInt(
					elm$core$Basics$round(shadow.r.bi)) + (', ' + (elm$core$String$fromInt(
					elm$core$Basics$round(shadow.p.bi)) + (', ' + (elm$core$String$fromFloat(shadow.o.bi) + ')'))))))))))))))))));
			case 3:
				var x = prop.b;
				return _Utils_ap(
					elm$core$String$fromFloat(x.bi),
					x.bo);
			case 4:
				var x = prop.b;
				var y = prop.c;
				return _Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							delim,
							_Utils_ap(
								elm$core$String$fromFloat(y.bi),
								y.bo))));
			case 5:
				var x = prop.b;
				var y = prop.c;
							...
							_Utils_ap(
								...
								_Utils_ap(
									...
									_Utils_ap(
										delim,
										_Utils_ap(
											elm$core$String$fromFloat(z.bi),
											z.bo)))))));
			case 6:
				var w = prop.b;
				var x = prop.c;
				...
				var z = prop.e;
				return _Utils_ap(
					elm$core$String$fromFloat(w.bi),
					_Utils_ap(
						w.bo,
						_Utils_ap(
							delim,
...
var mdgriffith$elm_style_animation$Animation$Render$render3dRotation = function (prop) {
	if (prop.$ === 5) {
		...
		var y = prop.c;
		var z = prop.d;
		return 'rotateX(' + (elm$core$String$fromFloat(x.bi) + (x.bo + (') rotateY(' + (elm$core$String$fromFloat(y.bi) + (y.bo + (') rotateZ(' + (elm$core$String$fromFloat(z.bi) + (z.bo + ')'))))))));
	} else {
		return '';
	}
};
var mdgriffith$elm_style_animation$Animation$Render$renderValues = function (_n0) {
	var model = _n0;
	var _n1 = A2(elm$core$List$partition, mdgriffith$elm_style_animation$Animation$Render$isAttr, model.aW);
	var attrProps = _n1.a;
...
var author$project$Main$mainCanvas = function (model) {
	...
	var eqBC = A2(
		...
		{d: eq.f, c: eq.m},
		aPoint);
	var centerBC = author$project$Main$equilateralCenter(eqBC);
	var eqUpper = A2(
		author$project$Main$equilateral,
		{d: eqBC.e, c: eqAC.e},
		eq.f);
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'margin-top', '-90px')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						elm$svg$Svg$Attributes$width('750'),
						elm$svg$Svg$Attributes$height('750'),
						elm$svg$Svg$Attributes$viewBox('0 0 750 750'),
						author$project$Main$onClickWithOffset(author$project$Main$MouseClick)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$points(
										author$project$Main$equilateralAsString(model.g)),
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$cx(
										elm$core$String$fromFloat(aPoint.a)),
										elm$svg$Svg$Attributes$cy(
										elm$core$String$fromFloat(aPoint.b)),
								...
								A2(
								elm$svg$Svg$g,
								mdgriffith$elm_style_animation$Animation$render(model.D),
								_List_fromArray(
									[
										A2(
										elm$svg$Svg$polygon,
										_List_fromArray(
											[
												elm$svg$Svg$Attributes$points(
												author$project$Main$equilateralAsString(eqAB)),
												elm$svg$Svg$Attributes$strokeWidth('0'),
												elm$svg$Svg$Attributes$fill('#4A90E2')
											]),
										_List_Nil),
										A2(
										elm$svg$Svg$line,
										_List_fromArray(
											[
												...
												elm$core$String$fromFloat(aPoint.b + 4)),
												elm$svg$Svg$Attributes$x2(
												elm$core$String$fromFloat(prAB.a)),
												elm$svg$Svg$Attributes$y2(
												elm$core$String$fromFloat(prAB.b - 2)),
								...
								_List_fromArray(
									[
										...
										_Utils_ap(
											mdgriffith$elm_style_animation$Animation$render(model.D),
											mdgriffith$elm_style_animation$Animation$render(model.u)),
										_List_fromArray(
											[
												A2(
												elm$svg$Svg$g,
												mdgriffith$elm_style_animation$Animation$render(model.t),
												_List_fromArray(
													[
														A2(
														elm$svg$Svg$polygon,
														_List_fromArray(
															[
																elm$svg$Svg$Attributes$points(
																author$project$Main$equilateralAsString(eqAC)),
																elm$svg$Svg$Attributes$strokeWidth('0'),
																elm$svg$Svg$Attributes$fill('#B6D6CC')
															]),
														_List_Nil),
														A2(
														elm$svg$Svg$line,
														_List_fromArray(
															[
																...
																elm$core$String$fromFloat(aPoint.b)),
																elm$svg$Svg$Attributes$x2(
																elm$core$String$fromFloat(prAC.a)),
																elm$svg$Svg$Attributes$y2(
																elm$core$String$fromFloat(prAC.b)),
																elm$svg$Svg$Attributes$stroke('#eee'),
																elm$svg$Svg$Attributes$strokeWidth('1'),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$svg$Svg$Attributes$points(
																author$project$Main$equilateralAsString(eqBC)),
																elm$svg$Svg$Attributes$fill('none'),
																elm$svg$Svg$Attributes$strokeWidth('0'),
																elm$svg$Svg$Attributes$fill('#9BC53D')
															]),
														_List_Nil),
														A2(
														elm$svg$Svg$line,
														_List_fromArray(
															[
																...
																elm$core$String$fromFloat(aPoint.b)),
																elm$svg$Svg$Attributes$x2(
																elm$core$String$fromFloat(prBC.a)),
																elm$svg$Svg$Attributes$y2(
																elm$core$String$fromFloat(prBC.b)),
																elm$svg$Svg$Attributes$stroke('#eee'),
																elm$svg$Svg$Attributes$strokeWidth('1'),
																elm$svg$Svg$Attributes$strokeLinecap('butt')
															]),
												...
												_List_fromArray(
													[
														elm$svg$Svg$Attributes$points(
														author$project$Main$equilateralAsString(eqUpper)),
														elm$svg$Svg$Attributes$fill('none'),
														elm$svg$Svg$Attributes$strokeWidth('0')
													]),
												_List_Nil)
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Main$stepView, 0, model.E),
						A2(author$project$Main$stepView, 1, model.E),
						A2(author$project$Main$stepView, 2, model.E)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
var author$project$Main$main = elm$browser$Browser$element(
	{ba: author$project$Main$init, bl: author$project$Main$subscriptions, bp: author$project$Main$update, bs: author$project$Main$view});
