...
{
	if (region._.M === region.ai.M)
	{
		return 'on line ' + region._.M;
	}
	return 'on lines ' + region._.M + ' through ' + region.ai.M;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aQ: 'hidden', K: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aQ: 'mozHidden', K: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aQ: 'msHidden', K: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aQ: 'webkitHidden', K: 'webkitvisibilitychange' }
		: { aQ: 'hidden', K: 'visibilitychange' };
}
...
var the_sett$elm_color$Color$Color = F4(
	function (red, green, blue, alpha) {
		return {w: alpha, J: blue, L: green, N: red};
	});
...
var timjs$elm_collage$Collage$defaultLineStyle = {
	...
	V: _List_Nil,
	ag: 0,
	W: timjs$elm_collage$Collage$uniform(the_sett$elm_color$Color$black),
	am: 1,
	ab: timjs$elm_collage$Collage$thin
};
var timjs$elm_collage$Collage$broken = F3(
	function (dashes, thickness, fill) {
		return _Utils_update(
			timjs$elm_collage$Collage$defaultLineStyle,
			{V: dashes, W: fill, ab: thickness});
	});
...
var author$project$Main$rect = F2(
	function (color, len) {
		return A2(
			...
			A2(timjs$elm_collage$Collage$rectangle, len, 10));
	});
...
var timjs$elm_collage$Collage$Layout$distances = function (col) {
	var points = timjs$elm_collage$Collage$Layout$handleBasic(col.x);
...
var timjs$elm_collage$Collage$Layout$Right = 2;
...
var timjs$elm_collage$Collage$Layout$Down = 1;
var timjs$elm_collage$Collage$Layout$Left = 3;
var timjs$elm_collage$Collage$Layout$Up = 0;
...
var timjs$elm_collage$Collage$Layout$horizontal = A2(
	elm$core$List$foldr,
	timjs$elm_collage$Collage$Layout$beside(2),
	timjs$elm_collage$Collage$Layout$empty);
var author$project$Main$cantor = F2(
	function (len, depth) {
		if (!depth) {
			return A2(author$project$Main$rect, the_sett$elm_color$Color$blue, len);
		} else {
			return timjs$elm_collage$Collage$Layout$center(
				timjs$elm_collage$Collage$Layout$horizontal(
					_List_fromArray(
						[
							A2(author$project$Main$cantor, len / 3, depth - 1),
							A2(timjs$elm_collage$Collage$Layout$spacer, len / 3, 0),
							A2(author$project$Main$cantor, len / 3, depth - 1)
						])));
		}
	});
var author$project$Main$gap = A2(timjs$elm_collage$Collage$Layout$spacer, 20, 10);
...
var timjs$elm_collage$Collage$Layout$vertical = A2(
	elm$core$List$foldr,
	timjs$elm_collage$Collage$Layout$beside(1),
	timjs$elm_collage$Collage$Layout$empty);
...
var timjs$elm_collage$Collage$Render$decodeTransform = function (collage) {
	var sy = elm$core$String$fromFloat(collage.aB.b);
	var sx = elm$core$String$fromFloat(collage.aB.a);
	var r = elm$core$String$fromFloat((((-collage.aA) / 2) / elm$core$Basics$pi) * 360);
	var dy = elm$core$String$fromFloat(-collage.E.b);
	var dx = elm$core$String$fromFloat(collage.E.a);
	return elm$core$String$concat(
		_List_fromArray(
		...
		case 1:
			...
			return _List_fromArray(
				[
					...
					timjs$elm_collage$Collage$Render$decodeFill(line.W)),
					elm$svg$Svg$Attributes$strokeOpacity(
					timjs$elm_collage$Collage$Render$decodeFillOpacity(line.W)),
					elm$svg$Svg$Attributes$strokeWidth(
					elm$core$String$fromFloat(line.ab)),
					elm$svg$Svg$Attributes$strokeLinecap(
					timjs$elm_collage$Collage$Render$decodeCap(line.ad)),
					elm$svg$Svg$Attributes$strokeLinejoin(
					timjs$elm_collage$Collage$Render$decodeJoin(line.am)),
					elm$svg$Svg$Attributes$fill('none'),
					elm$svg$Svg$Attributes$opacity(
					elm$core$String$fromFloat(collage.a$)),
					elm$svg$Svg$Attributes$transform(
					timjs$elm_collage$Collage$Render$decodeTransform(collage)),
					elm$svg$Svg$Attributes$strokeDashoffset(
					elm$core$String$fromInt(line.ag)),
					elm$svg$Svg$Attributes$strokeDasharray(
					timjs$elm_collage$Collage$Render$decodeDashing(line.V))
				]);
		case 0:
			var _n1 = _n0.a;
			var fill = _n1.a;
			...
			return _List_fromArray(
				[
					...
					timjs$elm_collage$Collage$Render$decodeFill(
						timjs$elm_collage$Collage$Core$Uniform(style.aL))),
					...
					elm$core$String$fromInt(style.a3)),
...
var timjs$elm_collage$Collage$Render$render = function (collage) {
	render:
	while (true) {
		var name = A2(elm$core$Maybe$withDefault, '_unnamed_', collage.aX);
		var _n0 = collage.x;
		switch (_n0.$) {
			case 1:
				var style = _n0.a;
				...
				return A2(
					...
					_Utils_ap(
						...
						_Utils_ap(
							...
							timjs$elm_collage$Collage$Render$events(collage.aP))),
					_List_Nil);
			case 0:
				var _n2 = _n0.a;
				var fill = _n2.a;
				...
				switch (shape.$) {
					...
					default:
						...
						var $temp$collage = _Utils_update(
							collage,
							{
								x: A2(timjs$elm_collage$Collage$Core$Path, line, path)
							});
			...
			default:
				...
				var $temp$collage = _Utils_update(
					collage,
					{
						x: timjs$elm_collage$Collage$Core$Group(
							_List_fromArray(
								[fore, back]))
					});
				collage = $temp$collage;
...
var author$project$Main$view = function (model) {
	var row = function (n) {
		return _List_fromArray(
			[
				author$project$Main$gap,
				A2(author$project$Main$cantor, 700, n)
			]);
	};
